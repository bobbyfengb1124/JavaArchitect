...
import my.spring.framework.service.IQueryService;
...
public class DemoAction {
    ...
    public MyModelAndView add(HttpServletRequest req, HttpServletResponse resp, @MyRequestParam("name") String name, @MyRequestParam("addr") String addr) {
